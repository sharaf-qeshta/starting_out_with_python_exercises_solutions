...
object_mass = float(input("enter objcet`s mass (in kilograms): "))
object_velocity = float(input("enter object`s velocity: "))
print(f"the kinetic energy for this object is {kinetic_energy(object_mass, object_velocity)}")